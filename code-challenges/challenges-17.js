...
const recursionPattern = (int1,int2) => {
    ...
    if(int1 == -4){
        op = "summation";
    }else if (int1 + int2 == first[0]){
        first.push(int1+int2);
        return first;
    }else if(op == "minus"){
        first.push(int1 - int2);
    ...
    recursionPattern(int1,int2)

};

//     function recurrsion2(int1,int2) {
//         if(int1-int2 > 0){
//             arr.push(int1-int2)
//             recurrsion2(int1-int2,int2)
...
const filterLinks = (str) => {
    // write your code here
    let regex = /(www.)+([\w])+(.net|.com|.org)/gi;

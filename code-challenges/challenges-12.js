...
const oddFiltration = (arr) => {
    ...
    let values = arr.filter((element) => element % 2 != 0);
    return values;
}
// -------------------------------------------------------------------------------------------------------
...
const skillComparison = (arr1, arr2) => {
    // write your code here
    let skillarr = arr1.filter((ele) => arr2.indexOf(ele) == -1);
    let skillarr2 = arr2.filter((ele) => arr1.indexOf(ele) == -1);
    return [...skillarr, ...skillarr2];
}
// -------------------------------------------------------------------------------------------------------

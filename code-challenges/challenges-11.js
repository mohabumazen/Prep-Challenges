...
function square(arr) {
    ...
    const map1 = arr.map(ele => ele * ele)
    return map1
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    // write your code here
    const newArr = arr.map((element) => `${element.firstName} ${element.lastName}`);
    return newArr
...
function gradesAvg(arr) {
    // write your code here
    // const newarry = gradesAvg.map(function(elem){
    //     return (`${elem.gradsList}`/(gradsList.length))
    // })
}
// -------------------------------------------------------------------------------------------------------
